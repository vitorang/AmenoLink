...
import { HandlerRegisterModal, HandlerRegisterModalData } from '../handler-register-modal/handler-register-modal';
...
export class ProgramDetails {
  ...
  onAddHandler(): void {
    const dialogRef = this.dialog.open<HandlerRegisterModal, HandlerRegisterModalData, ProgramConfigHandler>(
