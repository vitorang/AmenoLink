...
from ._shared import client_config
...
class ConnectionManager:
    ...
    def connect(
        ...
        url = f'{client_config.origin_url}/app-hub'
        if client_config.app_name:
            url = f'{url}?appName={quote(client_config.app_name)}'
...
def connect(
    ...
    connection_manager.connect(on_status_change=on_status_change, max_attempts=max_attempts)